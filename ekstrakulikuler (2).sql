...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2026 at 08:21 AM
...
INSERT INTO `guru` (`id_guru`, `nip`, `nama_guru`, `id_user`, `jenis_kelamin`, `no_hp`, `alamat`, `tempat_lahir`, `tanggal_lahir`) VALUES
(1, '23161016', 'Kalpas', 2, 'laki-laki', 0, '', '', '2026-01-12'),
(3, '1326943', 'Aponia', 36, 'laki-laki', 0, '', '', NULL),
(4, '574527275', 'Elysia', 39, 'laki-laki', 0, '', '', NULL),
(5, '3434', 'gg', 42, 'perempuan', 7565768, 'ada', 'btm', '2026-01-27');
...
(7, 5, 3, '2026-01-08', 'pending'),
(8, 5, 7, '2026-01-08', 'pending');
