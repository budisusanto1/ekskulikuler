                    ...
                    <div class="tab-pane fade" id="ekskul-form" role="tabpanel">
                        ...
                        <form action="<?= base_url('/inputekskul') ?>" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_ekskul" name="nama_ekskul" placeholder="Contoh: Basket, Pramuka, PMR" required>
                            </div>
                            <div class="mb-3">
                                <label for="id_instruktur" class="form-label">Instruktur / Pembina</label>
                                <select class="form-select" name="id_instruktur" required>
                                    <option value="">--Pilih Guru</option>
                                    <?php foreach ($guru as $g): ?>
                                        <option value="<?= $g->id_guru ?>"><?= $g->nama_guru ?></option>
                                    <?php endforeach; ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="kuota" name="kuota" placeholder="Maksimal peserta" min="1" required>
                            </div>
                            <button type="submit" class="btn btn-submit">Simpan</button>
                        </form>
                    </div>
